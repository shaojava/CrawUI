...
LRESULT WindowImplBase::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    ...
    styleValue |= (WS_SYSMENU |WS_MINIMIZEBOX/*|WS_MAXIMIZEBOX*/);
		...
		case UILIB_ZIPRESOURCE:
			{
				...
				::FreeResource(hResource);
#endif
				m_PaintManager.SetResourceZip(GetResourceID(),m_lpResourceZIPBuffer, dwSize);
			}
			break;
		}
...
LRESULT WindowImplBase::OnActive(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{
    bHandled = FALSE;
    return 0;
}
...
LRESULT WindowImplBase::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_ACTIVATE:       lRes = OnActive(uMsg,wParam,lParam,bHandled);break;
	...
	void WindowImplBase::OnSelectItem(TNotifyUI& msg)
	{
		return;
	}

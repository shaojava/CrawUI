...
#define DUI_MSGTYPE_RETURN					(_T("editreturn"))
...
#define DUI_MSGTYPE_IDOK					(_T("IDOK"))
...
#define  DUI_CTR_TABBODY						 (_T("TabBody"))
#define  DUI_CTR_TABITEM						 (_T("TabItem"))

#define  DUI_CTR_CAPTCHA						 (_T("CAPTCHA"))

...
#define PI 3.1415926535897932384626433832795029L
	...
	CDxAnimationUI::CDxAnimationUI( const CDxAnimationUI& src )
	{
		...
		{
			throw "UiLib::CDxAnimationUI::CDxAnimationUI";
		}
	}
	...
	bool CAnimationSpooler::PrepareAnimation(HWND hWnd)
	{
		...
		m_p3DBackSurface->LockRect(&locked_rect, NULL, D3DLOCK_READONLY);
		TRenderObj _RenderObj;
		_RenderObj.hDC = hDC;
		_RenderObj.pBits = locked_rect.pBits;
		::SendMessage(hWnd, WM_PRINTCLIENT, (WPARAM)&_RenderObj, PRF_CHECKVISIBLE | PRF_CLIENT | PRF_ERASEBKGND | PRF_CHILDREN);
		m_p3DBackSurface->UnlockRect();
...
// 		RECT rcSurface = {0, 0, 900, 600};
// 		LPDIRECT3DSURFACE9      g_psysSurface   = NULL;
// 		m_p3DDevice->GetRenderTarget(0, &p3DTargetSurface);
// 		m_p3DDevice->CreateOffscreenPlainSurface(900, 600, 
// 			D3DFMT_A8R8G8B8, D3DPOOL_SYSTEMMEM, &g_psysSurface, NULL);
// 		m_p3DDevice->GetRenderTargetData(p3DTargetSurface, g_psysSurface);
...
// 
// 		
// 		memcpy(m_pBits, lockedRect.pBits, 4 * 900 * 600);
// 		memset(m_pBits,1,4*900*600);
// 		
// 		RECT rcWnd={0};
...
// 		
// 		//::BitBlt(GetDC(m_hWnd),0,0,900,600,m_hDC,0,0,SRCCOPY);
// 		::UpdateLayeredWindow(m_hWnd,GetDC(m_hWnd),&pt,&szWindow,m_hDC,&ptSrc,0,&blendPixelFunction,ULW_ALPHA);
// 
// 
